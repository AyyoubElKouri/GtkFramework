...
{
    GtkWidget *window = create_window(NULL, GTK_WINDOW_TOPLEVEL, "Morocco", 700, 460, FALSE, GTK_WIN_POS_CENTER, TRUE, NULL, 1, FALSE, NULL, NULL);
...
{
    GtkWidget *window = create_window(NULL, GTK_WINDOW_TOPLEVEL, "France", 700, 460, FALSE, GTK_WIN_POS_CENTER, TRUE, NULL, 1, FALSE, NULL, NULL);
...
{
    GtkWidget *window = create_window(NULL, GTK_WINDOW_TOPLEVEL, "Argentina", 700, 460, FALSE, GTK_WIN_POS_CENTER, TRUE, NULL, 1, FALSE, NULL, NULL);
...
{
    GtkWidget *window = create_window(NULL, GTK_WINDOW_TOPLEVEL, "Algérie", 700, 460, FALSE, GTK_WIN_POS_CENTER, TRUE, NULL, 1, FALSE, NULL, NULL);
...
{
    GtkWidget *window = create_window(NULL, GTK_WINDOW_TOPLEVEL, "Italie", 700, 460, FALSE, GTK_WIN_POS_CENTER, TRUE, NULL, 1, FALSE, NULL, NULL);
...
{
    GtkWidget *window = create_window(NULL, GTK_WINDOW_TOPLEVEL, "Arabie Saoudite", 700, 460, FALSE, GTK_WIN_POS_CENTER, TRUE, NULL, 1, FALSE, NULL, NULL);
