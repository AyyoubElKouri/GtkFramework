    ...
    GtkWidget *set_properties_dialog(dialogInfos *dialogInformations)
    {
        ...
        // ckeck the buttons
        if(dialogInformations->title3 == NULL)
            if(dialogInformations->title2 == NULL)
                if(dialogInformations->title1 == NULL)
            ...
            dialog = gtk_dialog_new_with_buttons(dialogInformations->title, GTK_WINDOW(dialogInformations->parent), dialogInformations->flags, dialogInformations->title1, dialogInformations->answer1, dialogInformations->title2, dialogInformations->answer2, dialogInformations->title3, dialogInformations->answer3, NULL);
