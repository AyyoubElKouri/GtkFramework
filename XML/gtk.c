...
GtkWidget *middle_space_box = create_box(GTK_ORIENTATION_VERTICAL, -1, 0);
GtkWidget *middle_space_paned = create_paned(GTK_ORIENTATION_VERTICAL, 500, TRUE);
GtkWidget *middle_space_display_box = create_box(GTK_ORIENTATION_VERTICAL, -1, 0);
...
add_to_box(middle_space_display_box, working_space_label_box, START, FALSE, FALSE, 0, 0, 0, 12, 7);
GtkWidget *test_button3 = create_button(GTK_RELIEF_NORMAL, "This space is reserved for the Working Space", FALSE, NULL, NULL, NULL);
add_to_box(middle_space_display_box, test_button3, START, TRUE, TRUE, 0, 7, 0, 0, 0);
add_to_paned(middle_space_paned, middle_space_display_box, FIRST);
...
add_to_box(widgets_informations_box, widgets_informations_label_box, START, FALSE, FALSE, 0, 7, 0, 12, 7);
...
add_to_paned(middle_space_paned, widgets_informations_box, SECOND);
add_to_box(middle_space_box, middle_space_paned, START, TRUE, TRUE, 0, 7, 0, 7, 7);
add_to_paned(build_space_paned, middle_space_box, FIRST);
...
add_to_box(second_space_box, test_button2, START, TRUE, TRUE, 0, 7, 0, 7, 0);
