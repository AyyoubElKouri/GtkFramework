...
GtkWidget *scrolled_windows_window = create_scrolled_window(FALSE, TRUE);
GtkWidget *Windows_box = create_box(GTK_ORIENTATION_VERTICAL, -1, 0);
GtkWidget *Windows = create_button(GTK_RELIEF_NORMAL, "Windows", FALSE, NULL, NULL, NULL);
add_to_box(Windows_box, Windows, START, TRUE, TRUE, 0, 7, 0, 0, 0);
GtkWidget *Windows2 = create_button(GTK_RELIEF_NORMAL, "Windows", FALSE, NULL, NULL, NULL);
add_to_box(Windows_box, Windows2, START, TRUE, TRUE, 0, 0, 0, 0, 0);
GtkWidget *Windows3 = create_button(GTK_RELIEF_NORMAL, "Windows", FALSE, NULL, NULL, NULL);
add_to_box(Windows_box, Windows3, START, TRUE, TRUE, 0, 0, 0, 0, 0);
GtkWidget *Windows4 = create_button(GTK_RELIEF_NORMAL, "Windows", FALSE, NULL, NULL, NULL);
add_to_box(Windows_box, Windows4, START, TRUE, TRUE, 0, 0, 0, 0, 0);
add_to_scrolled_window(scrolled_windows_window, Windows_box);
add_to_stack(stack_catalog, scrolled_windows_window, "Windows");
GtkWidget *scrolled_containers_window = create_scrolled_window(FALSE, TRUE);
GtkWidget *Containers_box = create_box(GTK_ORIENTATION_VERTICAL, -1, 0);
...
GtkWidget *Widgets_box = create_box(GTK_ORIENTATION_VERTICAL, -1, 0);
