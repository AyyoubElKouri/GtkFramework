...
add_to_grid(button_grid, button_relief_label, 0, 0, 1, 1);
...
add_to_grid(check_button_grid, check_button_label_label, 0, 0, 1, 1);
GtkWidget *check_button_label_entry = create_entry(NULL, NULL, TRUE, TRUE, 20, 0.5);
add_to_grid(check_button_grid, check_button_label_entry, 0, 1, 1, 1);
GtkWidget *check_button_active_label = create_label("Active", 12, "Arial", "#000000", "#f6f5f4", GTK_JUSTIFY_LEFT, FALSE, 0, 0, TRUE);
add_to_grid(check_button_grid, check_button_active_label, 1, 0, 1, 1);
...
add_to_grid(check_button_grid, check_button_active_combo_box, 1, 1, 1, 1);
...
add_to_grid(check_button_grid, check_button_use_underline_label, 2, 0, 1, 1);
...
add_to_grid(color_button_grid, color_button_use_alpha_combo_box, 2, 1, 1, 1);
GtkWidget *color_button_add_button = create_button(GTK_RELIEF_NORMAL, "                                                               Add                                                               ", FALSE, NULL, NULL, NULL);
add_to_grid(color_button_grid, color_button_add_button, 3, 0, 2, 1);
...
add_to_grid(entry_box_grid, entry_visibility_combo_box, 2, 1, 1, 1);
GtkWidget *entry_editable_label = create_label("Editable", 12, "Arial", "#000000", "#f6f5f4", GTK_JUSTIFY_LEFT, FALSE, 0, 0, TRUE);
add_to_grid(entry_box_grid, entry_editable_label, 3, 0, 1, 1);
...
add_to_grid(font_button_grid, font_button_show_size_combo_box, 2, 1, 1, 1);
GtkWidget *font_button_use_size_label = create_label("Use Size", 12, "Arial", "#000000", "#f6f5f4", GTK_JUSTIFY_LEFT, FALSE, 0, 0, TRUE);
add_to_grid(font_button_grid, font_button_use_size_label, 3, 0, 1, 1);
...
add_to_grid(font_button_grid, font_button_use_size_combo_box, 3, 1, 1, 1);
GtkWidget *font_button_use_font_label = create_label("Use Font", 12, "Arial", "#000000", "#f6f5f4", GTK_JUSTIFY_LEFT, FALSE, 0, 0, TRUE);
add_to_grid(font_button_grid, font_button_use_font_label, 4, 0, 1, 1);
...
add_to_grid(font_button_grid, font_button_use_font_combo_box, 4, 1, 1, 1);
GtkWidget *font_button_add_button = create_button(GTK_RELIEF_NORMAL, "                                                               Add                                                               ", FALSE, NULL, NULL, NULL);
add_to_grid(font_button_grid, font_button_add_button, 5, 0, 2, 1);
