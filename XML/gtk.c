...
GtkWidget *window_case = create_box(GTK_ORIENTATION_VERTICAL, -1, 5);
GtkWidget *window_label = create_label("Window", 14, "Arial", "#000000", "#f6f5f4", GTK_JUSTIFY_RIGHT, FALSE, 0, 0, TRUE);
add_to_box(window_case, window_label, START, FALSE, FALSE, 0, 5, 0, 0, 7);
GtkWidget *window_informations_main_box = create_box(GTK_ORIENTATION_HORIZONTAL, GTK_ALIGN_START, 0);
...
add_to_box(window_informations_main_box, window_informations_grid, START, TRUE, FALSE, 0, 0, 0, 0, 0);
add_to_box(window_case, window_informations_main_box, START, FALSE, FALSE, 0, 5, 0, 0, 7);
...
add_to_box(Header_bar_case, header_bar_label, START, TRUE, FALSE, 0, 0, 0, 0, 7);
...
add_to_box(header_bar_informations_main_box, header_bar_informations_grid, START, TRUE, FALSE, 0, 14, 0, 0, 0);
add_to_box(Header_bar_case, header_bar_informations_main_box, START, FALSE, FALSE, 0, 5, 0, 0, 7);
...
add_to_box(scrolled_window_case, scrolled_window_label, START, TRUE, FALSE, 0, 0, 0, 0, 7);
...
add_to_box(scrolled_window_case, scrolled_window_informations_main_box, START, FALSE, FALSE, 0, 5, 0, 0, 7);
...
add_to_box(Box_case, Box_case_label, START, TRUE, FALSE, 0, 0, 0, 0, 7);
...
add_to_box(Box_case, Box_case_informations_main_box, START, FALSE, FALSE, 0, 5, 0, 0, 7);
...
add_to_box(Fixed_box, Fixed_label, START, FALSE, FALSE, 0, 0, 7, 0, 0);
...
add_to_box(Fixed_box, Fixed_grid, START, FALSE, FALSE, 0, 0, 0, 0, 0);
...
add_to_box(Frame_box, Frame_label, START, FALSE, FALSE, 0, 0, 0, 0, 0);
...
add_to_box(Frame_box, Frame_grid, START, FALSE, FALSE, 0, 14, 0, 0, 0);
add_to_box(Containers_box, Frame_box, START, TRUE, TRUE, 0, 0, 0, 0, 0);
...
add_to_box(Grid_box, Grid_label, START, FALSE, FALSE, 0, 0, 0, 0, 0);
...
add_to_box(Grid_box, Grid_grid, START, FALSE, FALSE, 0, 14, 0, 0, 0);
...
add_to_box(Paned_box, Paned_label, START, FALSE, FALSE, 0, 0, 0, 0, 0);
...
add_to_box(Paned_box, Paned_grid, START, FALSE, FALSE, 0, 14, 0, 0, 0);
add_to_box(Containers_box, Paned_box, START, TRUE, TRUE, 0, 14, 0, 0, 10);
...
add_to_box(Stack_box, Stack_label, START, FALSE, FALSE, 0, 0, 7, 0, 0);
...
add_to_box(Stack_box, Stack_grid, START, FALSE, FALSE, 0, 0, 0, 0, 0);
...
add_to_box(Switcher_box, Switcher_label, START, TRUE, TRUE, 0, 14, 10, 0, 0);
...
add_to_box(Switcher_box, Switcher_grid, START, FALSE, FALSE, 0, 0, 0, 0, 0);
add_to_box(Containers_box, Switcher_box, START, TRUE, TRUE, 0, 14, 0, 0, 0);
GtkWidget *Containers = create_button(GTK_RELIEF_NORMAL, "Containers", FALSE, NULL, NULL, NULL);
add_to_box(Containers_box, Containers, START, TRUE, TRUE, 0, 17, 0, 0, 0);
GtkWidget *Containers2 = create_button(GTK_RELIEF_NORMAL, "Containers", FALSE, NULL, NULL, NULL);
add_to_box(Containers_box, Containers2, START, TRUE, TRUE, 0, 0, 0, 0, 0);
GtkWidget *Containers3 = create_button(GTK_RELIEF_NORMAL, "Containers", FALSE, NULL, NULL, NULL);
add_to_box(Containers_box, Containers3, START, TRUE, TRUE, 0, 0, 0, 0, 0);
GtkWidget *Containers4 = create_button(GTK_RELIEF_NORMAL, "Containers", FALSE, NULL, NULL, NULL);
add_to_box(Containers_box, Containers4, START, TRUE, TRUE, 0, 0, 0, 0, 0);
